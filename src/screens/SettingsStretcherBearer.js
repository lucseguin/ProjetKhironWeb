...
export default function SettingsStretcherBearer(props) {
  ...
  useEffect(() => {
      ...
      axios.get("/projetkhiron/accounts/bearer")
        .then((response) => {
                ...
                <Grid   container
                  ...
                  <Grid item xs={4} style={{minWidth: 400}}>
                    ...
                    >
                      ...
                      <Grid item xs={8}>
                        <FormControl>
                          <Input value={settings.serviceLevel} name="bearer-service-level" onChange={handleServiceLevelChange}  inputComponent={HoursMinutesSecondsMaskCustom} />
                        </FormControl>
                      </Grid>
                    </Grid>
                  </Grid>
