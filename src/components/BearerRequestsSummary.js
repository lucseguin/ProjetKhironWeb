      ...
      <Grid container
        ...
        <Grid item>
          <Typography variant="h6">
            Demande de brancarderie derniers 7 jours
          </Typography>
        </Grid>
        {props.showGraph?
        <Grid item>
        ...
        <Grid item>
          <TableContainer className={classes.tableContainer} size="small" component={Paper}>
            <Table className={classes.table} size="small" aria-label="demande brancarderie recentes" height="100%">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell className={classes.tableHeaderCell} >Brancardier</TableCell>
